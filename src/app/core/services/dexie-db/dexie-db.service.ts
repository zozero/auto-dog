...
export class DexieDBService extends Dexie {
  ...
  constructor() {
    ...
    this.version(1.91).stores({
      ...
      taskExecuteResultInfoTable: '++id,sort,[projectName+createTime+status],[projectName+createTime],projectName,start,end,status,updateTime,createTime',
    });
